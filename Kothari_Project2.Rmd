...
To do the analysis, I first added the information in the figure above to a CSV file, which can be downloaded from :
[link]  https://github.com/ravi-kothari/DATA-607/blob/master/Assignment6.csv
...
We start by loading all the datasets for the analysis. I picked Walt Wells dataset for the walking dead ratings, then I took the dataset i suggested for English premiere league. I wanted to see how the spin off of the walking dead tv series called Fear the walking dead ratings are compared to original walking dead.
